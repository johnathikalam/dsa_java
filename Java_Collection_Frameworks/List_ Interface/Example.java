...
public class Example{
    public static void main(String [] args){
        ...
        list1.add(0,10);    // Add items to given index
        list1.add(20);  //add items to the end of the list
        System.out.println("Added items : " + list1);

        list1.addAll(list2);    //add list2 to the list1
        System.out.println("Combined list : " + list1);

        System.out.println("Value at index 3 : " + list1.get(3));   //to get item at given index

        System.out.println("Index of 5 : " + list1.indexOf(5));   // to get the index of an element at first instance

        System.out.println(list1.lastIndexOf(20));  //to get the index of the element at last instance
